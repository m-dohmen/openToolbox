...
const STRINGS = {
  en: {
    ...
    'dashboard.chart.rejected': 'Rejected chart declaration',
    'dashboard.chart.line.count': (dateLabel) => `${dateLabel} · count`,
    'dashboard.chart.line.sum': (dateLabel, fieldLabel) => `${dateLabel} · sum of ${fieldLabel}`,
    'dashboard.chart.title.count': 'count per month',
    'dashboard.chart.title.sum': (label) => `sum of ${label}`,
    'dashboard.chart.title.months': 'months',
    'dashboard.chart.kindUnknown': (kind) => `Unknown chart kind "${kind}" — allowed are bar, donut, line.`,
    'dashboard.chart.groupByMissing': 'A bar or donut chart needs groupBy.',
    'dashboard.chart.groupByUnknown': (field) => `groupBy names no existing field (got "${field}").`,
    'dashboard.chart.measureUnknown': (field) => `measure names no existing field (got "${field}").`,
    'dashboard.chart.measureNotNumeric': (label) => `"${label}" is not a numeric field — measure needs one.`,
    'dashboard.chart.dateFieldMissing': 'A line chart needs dateField.',
    'dashboard.chart.dateFieldUnknown': (field) => `dateField names no existing field (got "${field}").`,
    'dashboard.chart.dateFieldNotDate': (label) => `"${label}" is not a date field — dateField needs one.`,
    'dashboard.chart.aggregateUnknown': (aggregate) => `Unknown aggregate "${aggregate}" — allowed are count, sum.`,
    'dashboard.chart.sumFieldMissing': 'sum needs field.',
    'dashboard.chart.sumFieldUnknown': (field) => `field names no existing field (got "${field}").`,
    'dashboard.chart.sumFieldNotNumeric': (label) => `"${label}" is not a numeric field — sum needs one.`,
    'dashboard.chart.malformed': 'Chart declaration is malformed.',
  ...
  de: {
    ...
    'dashboard.chart.empty': 'Keine Daten',
    'dashboard.chart.rejected': 'Verworfene Diagramm-Deklaration',
    'dashboard.chart.line.count': (dateLabel) => `${dateLabel} · Anzahl`,
    'dashboard.chart.line.sum': (dateLabel, fieldLabel) => `${dateLabel} · Summe von ${fieldLabel}`,
    'dashboard.chart.title.count': 'Anzahl je Monat',
    'dashboard.chart.title.sum': (label) => `Summe von ${label}`,
    'dashboard.chart.title.months': 'Monate',
    'dashboard.chart.kindUnknown': (kind) => `Unbekannte Diagramm-Art „${kind}“ — erlaubt sind bar, donut, line.`,
    'dashboard.chart.groupByMissing': 'Balken- und Donut-Diagramme brauchen groupBy.',
    'dashboard.chart.groupByUnknown': (field) => `groupBy nennt kein vorhandenes Feld („${field}“).`,
    'dashboard.chart.measureUnknown': (field) => `measure nennt kein vorhandenes Feld („${field}“).`,
    'dashboard.chart.measureNotNumeric': (label) => `„${label}“ ist kein Zahlenfeld — measure braucht eines.`,
    'dashboard.chart.dateFieldMissing': 'Liniendiagramme brauchen dateField.',
    'dashboard.chart.dateFieldUnknown': (field) => `dateField nennt kein vorhandenes Feld („${field}“).`,
    'dashboard.chart.dateFieldNotDate': (label) => `„${label}“ ist kein Datumsfeld — dateField braucht eines.`,
    'dashboard.chart.aggregateUnknown': (aggregate) => `Unbekanntes Aggregat „${aggregate}“ — erlaubt sind count, sum.`,
    'dashboard.chart.sumFieldMissing': 'sum braucht field.',
    'dashboard.chart.sumFieldUnknown': (field) => `field nennt kein vorhandenes Feld („${field}“).`,
    'dashboard.chart.sumFieldNotNumeric': (label) => `„${label}“ ist kein Zahlenfeld — sum braucht eines.`,
    'dashboard.chart.malformed': 'Diagramm-Deklaration ist fehlerhaft.',
